  ...
  return (
    <Box sx={{ p: 3 }}>
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 3 }}>
        ...
        <Typography variant='h6' fontWeight={700}>Detail Maintenance</Typography>
      </Box>
        ...
        <Grid item xs={12} md={7}>
          <Card>
            <CardContent>
              ...
              <Divider sx={{ mb: 2 }} />
              {!progres ? (
                <Typography color='text.secondary'>Belum ada data progres maintenance</Typography>
              ) : (
