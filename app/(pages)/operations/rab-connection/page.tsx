...
export default function RabConnectionPage() {
  ...
  const [search, setSearch] = useFilterPersist('rab-connection-search', '');
          ...
          <CardContent>
            {loading ? (
              ...
              <EmptyState
                ...
                description={search ? 'Tidak ada hasil yang cocok dengan pencarian Anda' : 'Belum ada work order RAB yang disubmit oleh teknisi'}
              />
            ) : (
              <>
                  ...
                  <Table size='small' sx={{ minWidth: 600 }}>
                    ...
                    <TableBody>
                      {paginated.map((wo, idx) => {
                        ...
                        return (
                          <TableRow key={wo.id} hover onClick={() => router.push(`/operations/rab-connection/${wo.id}`)} sx={{ cursor: 'pointer' }}>
